    ...
    <div class="section">
      <div class="section__item">
        <div class="section__box">
          <a
            href="#0"
            class="r-link ai-element ai-element_padding-bottom ai-element2"
          >
        ...
        <div class="section__box">
          <button
            class="r-button ai-element ai-element_padding-bottom ai-element2"
          >
    ...
    <div class="section">
      <div class="section__item">
        <div class="section__box">
          <a
            href="#0"
            class="r-link ai-element ai-element_padding-bottom ai-element3"
          >
            <span class="ai-element__label">I'm a link</span>
          </a>
        </div>
        <div class="section__box">
          <button
            class="r-button ai-element ai-element_padding-bottom ai-element3"
          >
            <span class="ai-element__label">I'm a button</span>
          </button>
        </div>
    ...
    <div class="section">
      <div class="section__item">
        <div class="section__box">
          <a
            href="#0"
            class="r-link ai-element ai-element_padding-all ai-element1"
          >
            <span class="ai-element__label">I'm a link</span>
          </a>
        </div>
        <div class="section__box">
          <button
            class="r-button ai-element ai-element_padding-all ai-element1"
          >
            <span class="ai-element__label">I'm a button</span>
          </button>
        </div>
    ...
    <div class="section">
      <div class="section__item">
        <div class="section__box">
          <a
            href="#0"
            class="r-link ai-element ai-element_padding-all ai-element4"
          >
            <span class="ai-element__label">I'm a link</span>
          </a>
        </div>
        <div class="section__box">
          <button
            class="r-button ai-element ai-element_padding-all ai-element4"
          >
            <span class="ai-element__label">I'm a button</span>
          </button>
        </div>
    ...
    <div class="section">
      <div class="section__item">
        <div class="section__box">
          <a
            href="#0"
            class="r-link ai-element ai-element_padding-all ai-element5"
          >
            <span class="ai-element__label">I'm a link</span>
          </a>
        </div>
        <div class="section__box">
          <button
            class="r-button ai-element ai-element_padding-all ai-element5"
          >
            <span class="ai-element__label">I'm a button</span>
          </button>
        </div>
...
.section:nth-child(2n + 1) {
  background-color: rgba(89, 126, 231, 0.1);
}
...
.ai-element_bg::after {
  ...
  transition: opacity 0.35s ease-out 0.03s, -webkit-transform 0.35s ease-out;
